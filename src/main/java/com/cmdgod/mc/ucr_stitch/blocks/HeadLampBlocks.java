...
public class HeadLampBlocks {
    ...
    public static void registerHeads() {
        for (SkullType skullType : SkullBlock.Type.values()) {
            ...
            Registry.register(Registry.BLOCK, new Identifier(UCRStitch.MOD_NAMESPACE, name + "_lamp"), headLamp);
            Registry.register(Registry.BLOCK, new Identifier(UCRStitch.MOD_NAMESPACE, name + "_redstone_lamp"), headLampRedstone);
            Registry.register(Registry.BLOCK, new Identifier(UCRStitch.MOD_NAMESPACE, nameWall + "_lamp"), headLampWall);
            Registry.register(Registry.BLOCK, new Identifier(UCRStitch.MOD_NAMESPACE, nameWall + "_redstone_lamp"), headLampWallRedstone);

            Items i;
            Item item = new WallStandingBlockItem(headLamp, headLampWall, new Item.Settings().rarity(Rarity.RARE));
            UCRStitch.registerAndAddToCreativeMenu(item, name + "_lamp");
            Item itemRedstone = new WallStandingBlockItem(headLampRedstone, headLampWallRedstone, new Item.Settings().rarity(Rarity.RARE));
