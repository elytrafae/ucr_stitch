...
public class UCRStitchConfig extends ConfigWrapper<com.cmdgod.mc.ucr_stitch.config.ConfigModel> {
    ...
    private final Option<java.lang.String> pvpOnSign = this.optionForKey(new Option.Key("pvpOnSign"));
    private final Option<java.lang.String> pvpOffSign = this.optionForKey(new Option.Key("pvpOffSign"));
    ...
    public java.lang.String pvpOnSign() {
        return pvpOnSign.value();
    }

    public void pvpOnSign(java.lang.String value) {
        pvpOnSign.set(value);
    }

    public java.lang.String pvpOffSign() {
        return pvpOffSign.value();
    }

    public void pvpOffSign(java.lang.String value) {
        pvpOffSign.set(value);
    }
